...
export class Initial1685203743221 implements MigrationInterface {
    name = 'Initial1685203743221'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "wish" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "price" integer NOT NULL, "rating" integer NOT NULL, "link" character varying NOT NULL, "collectionId" integer, "imageId" integer, CONSTRAINT "REL_438d82247b32f3559b9f1157e4" UNIQUE ("imageId"), CONSTRAINT "PK_e338d8f62014703650439326d3a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "collection" ("id" SERIAL NOT NULL, "public" boolean NOT NULL, "name" character varying NOT NULL, "description" character varying, "userId" uuid, CONSTRAINT "PK_ad3f485bbc99d875491f44d7c85" PRIMARY KEY ("id"))`);
